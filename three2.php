...
<body>
    <?php
    $name = "وجيه ايوب شعيب  شيخ العيد";
    $job = "aoob ayube";
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        $name = utf8_encode($_POST['name']);
        $job = utf8_encode($_POST['job']);
    }
    ?>
    <div id="capture">
        <img src="img/finale2.jpeg" width="100%" height="450px">
        <div class=" form-data" style="display:flex;justify-content:center;align-items:center;flex-direction:column;flex-wrap:wrap">
            <div class="dataName" style="font-family: 'Tajawal', sans-serif;font-size:30px;"><?php echo $name ?></div>
            <div style="font-family: 'Tajawal', sans-serif;font-size:30px;
  justify-content: space-between;
"><?php echo $job ?></div><br>


            <img src="img/footer2.jpeg" height="15%" width="90%" style="margin-top:10px">

        </div>


        <button class="" style="
    background: red;" id="btn_convert" onclick="doCapture()">save image</button>
    </div>
    <script>
        function doCapture() {
            window.scrollTo(0, 0);
