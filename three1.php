...
<body>
    ...
    require 'utf8.php';
    $arbic = new  Arabic();
    echo     $arbic->utf8Glyphs("وجيه ايوب شيخ العيد");
    ...
    ?>
    <div id="myHtml">
        <img src="img/finale2.jpeg" width="100%">
...
"><?php echo $job ?></div><br>
            ...
            <img src="img/footer2.jpeg" width="90%" style="margin-top:10px">

        </div>


        <button class="" style="
    background: red;" id="btn_convert">save image</button>
    </div>
    <script>
